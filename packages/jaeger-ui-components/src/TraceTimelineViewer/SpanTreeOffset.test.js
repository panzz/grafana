...
describe('SpanTreeOffset', () => {
  ...
  describe('icon', () => {
    ...
    it('renders IoChevronForward if props.span.hasChildren is true and props.childrenVisible is false', () => {
      expect(wrapper.find(IoChevronForward).length).toBe(1);
      expect(wrapper.find(IoChevronDown).length).toBe(0);
    });

    it('renders IoChevronDown if props.span.hasChildren is true and props.childrenVisible is true', () => {
